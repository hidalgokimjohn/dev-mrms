            ...
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item <?php $app->sidebar_active('search', $_GET['p']); ?>">
                        <a data-target="#search" data-toggle="collapse" class="sidebar-link <?php $app->sidebar_collapsed('search', $_GET['p']); ?>">
                            <i class="align-middle" data-feather="search"></i> <span class="align-middle">Search</span>
                        </a>
                        <ul id="search" class="sidebar-dropdown list-unstyled collapse <?php $app->sidebar_showList('search', $_GET['p']); ?>" data-parent="#sidebar">
                            <li class="sidebar-item <?php $app->sidebar_active('af_cbrc', $_GET['modality']); ?>"><a class="sidebar-link" href="home.php?p=search&modality=af_cbrc">KC-AF CBRC</a>
                            </li>
                            <li class="sidebar-item <?php $app->sidebar_active('ipcdd_drom', $_GET['modality']); ?>"><a class="sidebar-link" href="home.php?p=search&modality=ipcdd_drom">IPCDD DROM</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-item <?php $app->sidebar_active('dashboards', $_GET['p']); ?>">
                        ...
                        <ul id="dashboards" class="sidebar-dropdown list-unstyled collapse <?php $app->sidebar_showList('dashboards', $_GET['p']); ?>" data-parent="#sidebar">
                            <li class="sidebar-item <?php $app->sidebar_active('af_cbrc', $_GET['modality']); ?>"><a class="sidebar-link" href="home.php?p=dashboards&modality=af_cbrc">KC-AF CBRC</a>
                            </li>
                            <li class="sidebar-item <?php $app->sidebar_active('ipcdd_drom', $_GET['modality']); ?>"><a class="sidebar-link" href="home.php?p=dashboards&modality=ipcdd_drom">IPCDD DROM</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-item <?php $app->sidebar_active('modules', $_GET['p']); ?>">
                        ...
                        <ul id="pages" class="sidebar-dropdown list-unstyled collapse <?php if ($_GET['m'] == 'dqa_conducted' || $_GET['m'] == 'dqa_items') {
                                                                                            echo 'show';
                                                                                        } ?>" data-parent="#sidebar">
                ...
                <div class="sidebar-cta">
                    <div class="sidebar-cta-content">
                        ...
                        <a href="https://adminkit.io/" class="btn btn-outline-primary btn-block" target="_blank">Click here</a>
                    </div>
                </div>
            </div>
        </nav>
                    ...
                    <ul class="navbar-nav navbar-align">
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-toggle="dropdown">
                                <img src="resources/img/avatars/default.jpg" class="avatar img-fluid rounded mr-1" alt="userImage" /> <span class="text-dark text-capitalize"><?php echo strtolower($_SESSION['user_fullname']); ?></span>
                            </a>
